...
/*
 * Pi::service('api')->ask(array('Text', 'keywords'), $keywords);
 * Pi::service('api')->ask(array('Text', 'description'), $description);
 * Pi::service('api')->ask(array('Text', 'alias'), $alias, $id, $model);
 */
